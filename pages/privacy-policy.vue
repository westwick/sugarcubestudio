<template>
  <div class="bg-white">
    <div class="container mx-auto py-16 px-4 text-black max-w-4xl">
      <h1 class="text-3xl font-bold text-center mb-12">Privacy Policy</h1>
      ...
      <div class="space-y-8">
        <section>
          ...
          <p>
            ...
            our Terms and Conditions, which are accessible at Nowruz unless
        ...
        <section>
          ...
          <p class="mb-4">
            ...
            including but not limited to N/A. The information that we request
          ...
          <p>
            ...
            service providers used by the app Unity
          </p>
        </section>

        <section>
          <h2 class="text-2xl font-semibold mb-4">Log Data</h2>
          <p>
        ...
        <section>
          <h2 class="text-2xl font-semibold mb-4">Links to Other Sites</h2>
          <p>
        ...
        <section>
          ...
          <p class="mt-4">This policy is effective as of 2022-03-08</p>
        </section>
